          ...
          <div className=" relative flex items-center mt-4">
            ...
            {isUser && (
              <button
                ...
                className=" absolute right-0 text-zinc-500 bg-white hover:text-zinc-800 border-none  font-medium rounded-lg text-sm  py-2.5 text-center inline-flex items-center  "
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
